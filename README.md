...
- **Frontend:** TypeScript, Angular, Ionic, Vue.js, Nuxt.js, JavaScript, Swift, Objective-C, Java(Android)
- **Backend:** Python, PHP (Laravel, FuelPHP)
- **Database:** MariaDB, MySQL, Oracle Database
- **Cloud/Infra:** AWS (EC2, S3, RDS, CloudFront, Route 53, Lambda@Edge), Firebase, Docker
- **AI:** Langchain, OpenAI API, Dify
- **Tools & Others:** Git, BackLog, ChatGPT, Project Facilitation, Process Improvement
---
